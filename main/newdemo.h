...
extern void newdemo_record_render_object(dxxobject * obj);
extern void newdemo_record_viewer_object(dxxobject * obj);
...
extern void newdemo_record_wall_hit_process( segnum_t segnum, int side, int damage, int playernum );
extern void newdemo_record_trigger( segnum_t segnum, int side, int objnum,int shot );
...
extern void newdemo_record_wall_toggle(segnum_t segnum, int side );
...
extern void newdemo_record_effect_blowup(segnum_t, int, vms_vector *);
...
extern void newdemo_record_door_opening(segnum_t segnum, int side);
