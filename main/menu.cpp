...
static void input_config_sensitivity()
{
	...
	nm_set_item_text(& m[nitems], "Joystick Sensitivity:"); nitems++;
	joysens = nitems;
...
void graphics_config()
{
	...
	nm_set_item_radio(&m[nitems], "None (Classical)", 0, 0); nitems++;
	nm_set_item_radio(&m[nitems], "Bilinear", 0, 0); nitems++;
	nm_set_item_radio(&m[nitems], "Trilinear", 0, 0); nitems++;
	nm_set_item_radio(&m[nitems], "Anisotropic", 0, 0); nitems++;
	opt_gr_movietexfilt = nitems;
	nm_set_item_checkbox(&m[nitems], "Movie Filter", GameCfg.MovieTexFilt); nitems++;
	nm_set_item_text(& m[nitems], ""); nitems++;
#endif
...
#define ADD_CHECK(n,txt,v)  nm_set_item_checkbox(&m[n],txt,v);
