...
extern void create_all_vertex_lists(int *num_faces, int *vertices, segnum_t segnum, int sidenum);

//like create_all_vertex_lists(), but generate absolute point numbers
extern void create_abs_vertex_lists(int *num_faces, int *vertices, segnum_t segnum, int sidenum, const char *calling_file, int calling_linenum);
...
//      Return the distance.
extern fix find_connected_distance(vms_vector *p0, segnum_t seg0, vms_vector *p1, segnum_t seg1, int max_depth, int wid_flag);
...
extern void pick_random_point_in_seg(vms_vector *new_pos, segnum_t segnum);
