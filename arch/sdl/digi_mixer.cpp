...
int digi_max_channels = MAX_SOUND_SLOTS;
...
// Volume 0-F1_0
int digi_mixer_start_sound(short soundnum, fix volume, int pan, int looping, int loop_start, int loop_end, int)
{
...
int digi_mixer_is_sound_playing(int) { return 0; }
