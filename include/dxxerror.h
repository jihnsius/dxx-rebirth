...
DECLSPEC_NORETURN void Error(const char *func, unsigned line, const char *fmt,...) __noreturn __attribute_gcc_format((printf, 3, 4));				//exit with error code=1, print message
